...
namespace Query.Persistence.Repositories
{
        ...
        where TEntity : Entity<TKey>
    {
        ...
        public async Task<TEntity?> FirstOrDefaultAsync(bool isTracking = false, Expression<Func<TEntity, bool>>? predicate = null, CancellationToken cancellationToken = default, params Expression<Func<TEntity, object>>[] includeProperties)
        {
            var query = Entities.AsQueryable();
            if (includeProperties.Any())
            {
